...
<b>NOTICE:</b> For the BCC tomorrow, you will be coming to our usual class. We will be doing the contest on paper, so no need to worry about logging in using the code I have sent previously (although you may still use that tonight to practice). Expect to end around 10:50, into short break. Mr. Merrick will be proctoring the last bit, from 10:46 to the end. You can bring pencils, erasers, and a simple calculator (you don’t need a calculator for anything, but it is allowed).

<a href="https://forms.gle/KntFx69KTh1u6CZh9"> Feedback form </a>
...
* <a href="https://vchan2.github.io/2020gr4/Mini-math_Gr4.pdf"> Mini-math </a>
